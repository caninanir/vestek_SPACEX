...
dependencies {
    ...
    testImplementation("org.jetbrains.kotlinx:kotlinx-coroutines-test:1.8.0") // Updated for consistency
    testImplementation("io.mockk:mockk:1.13.5") // Updated to latest version
