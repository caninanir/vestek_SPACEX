        ...
        Column(
            ...
            Box(
                ...
                IconButton(onClick = onClose, modifier = Modifier.size(48.dp)) {
                    ...
                    Text(
                        modifier = Modifier.padding(start = 78.dp, end = 78.dp, bottom = 36.dp).align(Alignment.TopCenter),
...
// Date Section
            Box(
                ...
                Row(
                    modifier = Modifier.fillMaxWidth(),
                    horizontalArrangement = Arrangement.SpaceEvenly // This helps evenly space the columns
                ) {
                    Column(
                        horizontalAlignment = Alignment.CenterHorizontally,
                        modifier = Modifier.weight(1f) // Ensures equal space for each column
                    ) {
